...
config :orchestrator,
  browser_strategy: System.get_env("BROWSER_STRATEGY", "headless_first") |> String.to_atom(),
  pipeline_runner_path: System.get_env("PIPELINE_RUNNER_PATH", "../tools/pipeline_runner"),
